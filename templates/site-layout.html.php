...
<head>
  ...
  <title>Sports Warehouse Online</title>
  ...
  <div class="site-wrapper">
    <header>
      ...
      <div class="logo-container">
        ...
        <form action="search-products.php" method="post" role="search">
          <input type="text" id="search-text" name="search-text" placeholder="Search Products" aria-label="search" />
          <button type="submit" id="submit" name="submit" aria-label="submit">
    ...
    <div class="slideshow">
      <div class="slideshow___photoframe">
        ...
        <div class="slideshow__indicators">
          <img src="./assets/images/indicator-active.png" alt="" width="14" height="14" />
          <img src="./assets/images/indicator.png" alt="" width="14" height="14" />
          <img src="./assets/images/indicator.png" alt="" width="14" height="14" />
        </div>
      </div>
      ...
      <section class="brands">
        ...
        <div class="brands__container">
          ...
          <ul class="brands__items">
            ...
            <li class="brands__item">
              <div class="brands__item-photoframe">
                <img src="./assets/images/logo_wilson.png" alt="wilson logo" width="80" height="19" />
              </div>
            </li>
          </ul>
        </div>
        ...
        <ul class="contact__items">
          <li>
            <div class="contact__item">
              <a href="#" class="contact__link" aria-label="facebook"><i class="fa fa-facebook-f"></i></a>
            </div>
            Facebook
          </li>
          <li>
            <div class="contact__item">
              <a href="#" class="contact__link" aria-label="twitter"><i class="fa fa-twitter"></i></a>
            </div>
            Twitter
          </li>
          <li>
            <div class="contact__item">
              <a href="#" class="contact__link" aria-label="other"><i class="fa fa-paper-plane"></i></a>
            </div>
            Other
